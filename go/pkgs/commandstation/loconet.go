...
// LocoNet is a Station over a LocoNet serial or TCP transport. It also
// implements TrackPowerController, SlotManager, and related slot interfaces.
type LocoNet struct {
	t lnTransport
...
// NewLocoNetSerial opens a LocoNet Station on a serial device (for example
// an Uhlenbrock 63120 or Digitrax PR3). baudrate is typically 57600.
...
// NewLocoNetTCP connects to a LoconetOverTcp / LbServer ASCII gateway
// (SEND/RECEIVE lines). Typical port is 5550.
