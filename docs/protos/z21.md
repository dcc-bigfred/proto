...
>
> **Firmware:** `LocoAddress` on the wire is the DCC address high-byte first (`26 02` = 9730), not little-endian and not X-Bus `0xC0`. `LAN_RAILCOM_GETDATA` still sends little-endian as specified.
